...
export const metadata: Metadata = {
  ...buildMetadata(
    ...
    'Reliable tree trimming in West Allis, WI with Urban Loggers LLC. Fully insured crews, 20+ years of experience. Call (414) 240-4626.',
...
export default function WestAllisTreeTrimmingPage() {
  const crumbs = [
  {
    "name": "Home",

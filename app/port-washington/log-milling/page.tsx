...
export const metadata: Metadata = {
  ...buildMetadata(
    'Log Milling in Port Washington, WI | Urban Loggers LLC',
    'Reliable log milling in Port Washington, WI with Urban Loggers LLC. Fully insured crews, 20+ years of experience. Call (414) 240-4626.',
    '/port-washington/log-milling/'
  ),
  other: {
    'geo.region': 'US-WI',
...
const faqs = [
  ...
  {
    "question": "Which logs are best for milling in Port Washington?",
...
export default function PortWashingtonLogMillingPage() {
  ...
  {
    "name": "Log Milling",
    "item": "https://urbanloggers.org/port-washington/log-milling/"
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema(
              'Log Milling',
              'On-site log milling for custom slabs and lumber from removed trees. in Port Washington, WI.',
              'https://urbanloggers.org/port-washington/log-milling/',
              'Log Milling Service',
              '$$'
            )
          ),
      ...
      <section className="relative text-white py-14 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Log Milling in Port Washington, WI</h1>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Port Washington Log Milling Focused on Safety and Results</h2>
          <p>Many of the oak and maple and hardwoods in Port Washington can be transformed into beautiful slabs instead of being hauled away. If you have a downed tree in Downtown Port, South Beach, Lake Michigan bluffs or a removal project near South Beach Park and Lake Michigan harbor and Upper Lake Park, we can mill the log on-site and help you keep that wood for furniture, shelving, or local woodworking projects. It’s a practical way to save material that would otherwise be chipped or dumped. You also get the satisfaction of reusing a tree that grew on your own property.</p>
          ...
          <p>Moisture levels can vary across Port Washington, so we tailor drying guidance based on where the slabs will be stored. Good airflow and consistent stacking make a big difference in the final quality.</p>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-charcoal mb-4">Need Log Milling in Port Washington?</h2>

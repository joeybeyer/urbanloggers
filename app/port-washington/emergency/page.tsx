...
export const metadata: Metadata = {
  ...buildMetadata(
    'Emergency Tree Service in Port Washington, WI | Urban Loggers LLC',
    'Reliable emergency tree service in Port Washington, WI with Urban Loggers LLC. Fully insured crews, 20+ years of experience. Call (414) 514-0750.',
    '/port-washington/emergency/'
  ),
  other: {
    'geo.region': 'US-WI',
...
const faqs = [
  {
    "question": "How fast can you respond to storm damage in Port Washington?",
...
export default function Port WashingtonEmergencyTreeServicePage() {
  const crumbs = [
  {
    "name": "Home",
  ...
  },
  {
    ...
    "item": "https://urbanloggers.org/port-washington/emergency/"
  }
]
    ...
    <>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema(
              ...
              'Emergency tree service for storm damage, hanging limbs, and urgent removals. in Port Washington, WI.',
              'https://urbanloggers.org/port-washington/emergency/',
      ...
      <section className="relative text-white py-14 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Emergency Tree Service in Port Washington, WI</h1>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Port Washington Emergency Tree Service Focused on Safety and Results</h2>
          <p>Storms can turn a healthy-looking tree into a hazard overnight. In Port Washington, high winds along South Beach Park and Lake Michigan harbor and Upper Lake Park often lead to split trunks, hanging limbs, and uprooted trees. Our emergency response team focuses on making the site safe first, then removing dangerous sections so you can protect your home and family.</p>
          ...
          <p>Our crews are trained to work safely around unstable trees and shifting limbs, which is critical during high-wind events in Port Washington.</p>
          ...
          <p>When storms hit Port Washington, we keep our schedule flexible to handle urgent calls. Save our number so you can reach us quickly if a tree becomes a hazard.</p>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-charcoal mb-4">Need Emergency Tree Service in Port Washington?</h2>

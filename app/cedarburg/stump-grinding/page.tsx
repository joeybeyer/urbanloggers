...
export const metadata: Metadata = {
  ...buildMetadata(
    'Stump Grinding in Cedarburg, WI | Urban Loggers LLC',
    'Reliable stump grinding in Cedarburg, WI with Urban Loggers LLC. Fully insured crews, 20+ years of experience. Call (414) 240-4626.',
    '/cedarburg/stump-grinding/'
  ),
  other: {
    'geo.region': 'US-WI',
...
const faqs = [
  {
    ...
    "answer": "Yes. We can grind surface roots that are causing trip hazards or lifting concrete, especially in older neighborhoods like Historic Downtown, Cedar Creek, Hamilton."
  },
  {
    "question": "What happens to the stump grindings?",
    "answer": "The chips can be used as mulch or hauled away. Many Cedarburg homeowners like to reuse the grindings in garden beds."
  },
  {
    "question": "How deep do you grind stumps in Cedarburg?",
...
export default function CedarburgStumpGrindingPage() {
  const crumbs = [
  {
    "name": "Home",
  ...
  {
    "name": "Stump Grinding",
    "item": "https://urbanloggers.org/cedarburg/stump-grinding/"
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema(
              'Stump Grinding',
              'Stump grinding and root flare cleanup to reclaim lawn and landscape space. in Cedarburg, WI.',
              'https://urbanloggers.org/cedarburg/stump-grinding/',
      ...
      <section className="relative text-white py-14 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Stump Grinding in Cedarburg, WI</h1>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Cedarburg Stump Grinding Focused on Safety and Results</h2>
          <p>Stumps take up valuable space and create trip hazards, especially on tighter Cedarburg lots. Whether the stump is in a front yard along Cedar Creek Park and Interurban Trail and Mill Museum area or a backyard in Historic Downtown, Cedar Creek, Hamilton, grinding it out is the quickest way to restore usable space. We grind below grade and leave the area ready for sod, seed, or new plantings.</p>
          ...
          <p>Stump grinding is also about what’s below the surface. We can address surface roots that cause uneven lawns or push up sidewalks, which is a common issue in established areas of Cedarburg. We’ll walk the area first so the grinding depth matches your landscaping plans.</p>
          <p>Grinding also removes the barrier for hardscape projects like walkways or patios. It’s a small step that unlocks a lot of landscaping flexibility for Cedarburg homeowners.</p>
          ...
          <p>Stump size and location vary a lot across Cedarburg. Older neighborhoods often have larger trunks and more established root systems, which can require deeper grinding or additional passes.</p>
          <p>We leave the site tidy and level. Many homeowners in Cedarburg appreciate that the area is ready for immediate landscaping without additional prep work.</p>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-charcoal mb-4">Need Stump Grinding in Cedarburg?</h2>

...
export const metadata: Metadata = {
  ...buildMetadata(
    'Log Milling in South Milwaukee, WI | Urban Loggers LLC',
    'Reliable log milling in South Milwaukee, WI with Urban Loggers LLC. Fully insured crews, 20+ years of experience. Call (414) 514-0750.',
    '/south-milwaukee/log-milling/'
  ),
  other: {
    'geo.region': 'US-WI',
...
const faqs = [
  ...
  {
    "question": "Which logs are best for milling in South Milwaukee?",
...
export default function South MilwaukeeLogMillingPage() {
  ...
  {
    "name": "Log Milling",
    "item": "https://urbanloggers.org/south-milwaukee/log-milling/"
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema(
              'Log Milling',
              'On-site log milling for custom slabs and lumber from removed trees. in South Milwaukee, WI.',
              'https://urbanloggers.org/south-milwaukee/log-milling/',
              'Log Milling Service',
              '$$'
            )
          ),
      ...
      <section className="relative text-white py-14 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Log Milling in South Milwaukee, WI</h1>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          ...
          <p>Moisture levels can vary across South Milwaukee, so we tailor drying guidance based on where the slabs will be stored. Good airflow and consistent stacking make a big difference in the final quality.</p>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-charcoal mb-4">Need Log Milling in South Milwaukee?</h2>

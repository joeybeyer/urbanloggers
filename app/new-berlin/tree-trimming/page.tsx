...
export const metadata: Metadata = {
  ...buildMetadata(
    'Tree Trimming in New Berlin, WI | Urban Loggers LLC',
    'Reliable tree trimming in New Berlin, WI with Urban Loggers LLC. Fully insured crews, 20+ years of experience. Call (414) 240-4626.',
    '/new-berlin/tree-trimming/'
  ),
  other: {
    'geo.region': 'US-WI',
...
const faqs = [
  {
    "question": "How often should trees be trimmed in New Berlin?",
  ...
  {
    "question": "Can trimming reduce storm damage in New Berlin?",
...
export default function NewBerlinTreeTrimmingPage() {
  ...
  {
    "name": "Tree Trimming",
    "item": "https://urbanloggers.org/new-berlin/tree-trimming/"
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema(
              'Tree Trimming',
              'Professional tree trimming including crown thinning, deadwood removal, and pruning. in New Berlin, WI.',
              'https://urbanloggers.org/new-berlin/tree-trimming/',
      ...
      <section className="relative text-white py-14 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Tree Trimming in New Berlin, WI</h1>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>New Berlin Tree Trimming Focused on Safety and Results</h2>
          <p>Healthy canopies are a huge part of what makes New Berlin look and feel established. In areas like City Center, Regal Manors, National Parkway, trees overhang sidewalks, alleys, and roofs. Strategic trimming keeps that canopy strong while improving clearance and reducing storm risk. We focus on clean cuts that respect how trees grow so they stay healthy for decades. The goal is balanced, long-lived trees—not quick cosmetic fixes.</p>
          ...
          <p>We can also set up ongoing maintenance plans for properties with multiple mature trees, helping New Berlin homeowners stay ahead of seasonal risks. Consistent care keeps trees stronger year after year.</p>
          <p>We also consider sightlines for intersections and driveways. In busier parts of New Berlin, improved visibility can be just as important as canopy health. That extra clearance keeps pedestrians and drivers safer year-round.</p>
          <h3>What to Expect During Your Tree Trimming</h3>
          <p>Trimming schedules can also be influenced by local tree species. Some New Berlin neighborhoods have a high concentration of maples and ashes, and those species benefit from more frequent deadwood removal. We’ll note any disease or stress patterns we see during the visit.</p>
          <p>If trimming reveals deeper issues like decay or a severe lean, we’ll explain the options. You get straightforward guidance from a local crew that knows New Berlin trees and property styles.</p>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-charcoal mb-4">Need Tree Trimming in New Berlin?</h2>

...
export const metadata: Metadata = {
  ...buildMetadata(
    'Stump Grinding in Brookfield, WI | Urban Loggers LLC',
    'Reliable stump grinding in Brookfield, WI with Urban Loggers LLC. Fully insured crews, 20+ years of experience. Call (414) 240-4626.',
    '/brookfield/stump-grinding/'
  ),
  other: {
    'geo.region': 'US-WI',
...
const faqs = [
  {
    ...
    "answer": "Yes. We can grind surface roots that are causing trip hazards or lifting concrete, especially in older neighborhoods like Brookfield Hills, Calhoun, Deer Creek."
  },
  {
    "question": "What happens to the stump grindings?",
    "answer": "The chips can be used as mulch or hauled away. Many Brookfield homeowners like to reuse the grindings in garden beds."
  },
  {
    "question": "How deep do you grind stumps in Brookfield?",
...
export default function BrookfieldStumpGrindingPage() {
  const crumbs = [
  {
    "name": "Home",
  ...
  {
    "name": "Stump Grinding",
    "item": "https://urbanloggers.org/brookfield/stump-grinding/"
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema(
              'Stump Grinding',
              'Stump grinding and root flare cleanup to reclaim lawn and landscape space. in Brookfield, WI.',
              'https://urbanloggers.org/brookfield/stump-grinding/',
      ...
      <section className="relative text-white py-14 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Stump Grinding in Brookfield, WI</h1>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Brookfield Stump Grinding Focused on Safety and Results</h2>
          <p>Stumps take up valuable space and create trip hazards, especially on tighter Brookfield lots. Whether the stump is in a front yard along Fox Brook Park and Brookfield Square and Poplar Creek or a backyard in Brookfield Hills, Calhoun, Deer Creek, grinding it out is the quickest way to restore usable space. We grind below grade and leave the area ready for sod, seed, or new plantings.</p>
          ...
          <p>Stump grinding is also about what’s below the surface. We can address surface roots that cause uneven lawns or push up sidewalks, which is a common issue in established areas of Brookfield. We’ll walk the area first so the grinding depth matches your landscaping plans.</p>
          <p>Grinding also removes the barrier for hardscape projects like walkways or patios. It’s a small step that unlocks a lot of landscaping flexibility for Brookfield homeowners.</p>
          ...
          <p>Stump size and location vary a lot across Brookfield. Older neighborhoods often have larger trunks and more established root systems, which can require deeper grinding or additional passes.</p>
          <p>We leave the site tidy and level. Many homeowners in Brookfield appreciate that the area is ready for immediate landscaping without additional prep work.</p>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-charcoal mb-4">Need Stump Grinding in Brookfield?</h2>

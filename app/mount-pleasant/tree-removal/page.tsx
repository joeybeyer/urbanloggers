...
export const metadata: Metadata = {
  ...buildMetadata(
    'Tree Removal in Mount Pleasant, WI | Urban Loggers LLC',
    'Reliable tree removal in Mount Pleasant, WI with Urban Loggers LLC. Fully insured crews, 20+ years of experience. Call (414) 514-0750.',
    '/mount-pleasant/tree-removal/'
  ),
  other: {
    'geo.region': 'US-WI',
...
const faqs = [
  {
    ...
    "answer": "Yes. Many homeowners in Mount Pleasant request log lengths for milling or firewood. Let us know your goals during the estimate and we’ll stage and cut accordingly."
  },
  {
    "question": "Do I need a permit for removing a tree in Mount Pleasant?",
  ...
  {
    "question": "How do you remove large trees in Mount Pleasant without damaging nearby homes?",
    "answer": "We use sectional removal with rigging so limbs and trunk pieces are lowered in controlled steps. That’s especially important on tight lots in areas like Mount Pleasant Village, Gorney Park area, Lammer where fences, garages, and nearby power lines leave little room for a full drop."
  },
  {
...
export default function Mount PleasantTreeRemovalPage() {
  const crumbs = [
  {
    "name": "Home",
  ...
  {
    "name": "Tree Removal",
    "item": "https://urbanloggers.org/mount-pleasant/tree-removal/"
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema(
              'Tree Removal',
              'Safe tree removal with rigging, cleanup, and optional log milling. in Mount Pleasant, WI.',
              'https://urbanloggers.org/mount-pleasant/tree-removal/',
      ...
      <section className="relative text-white py-14 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Tree Removal in Mount Pleasant, WI</h1>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Mount Pleasant Tree Removal Focused on Safety and Results</h2>
          <p>In Mount Pleasant, mature oak and maple and maples often tower over homes, garages, and tight side yards. In neighborhoods like Mount Pleasant Village, Gorney Park area, Lammer, that means removals have to be planned with precision. We use controlled rigging and sectional dismantling so heavy limbs are lowered safely without damaging roofs, fences, or landscaping. Our crew maps out drop zones, protects turf, and keeps pedestrian areas clear—especially near busier streets and shared driveways.</p>
          ...
          <p>Urban Loggers LLC is led by Brian Smith and backed by 20+ years of hands-on tree work. We’re fully insured and we show up with the right equipment—rigging systems, safety lines, and when necessary, cranes for large canopies. Our local experience means we know how to manage street parking, coordinate with neighbors, and keep the job tidy in busy parts of Mount Pleasant.</p>
          <p>If access is limited, we can stage equipment to minimize impact on lawns and landscaping. Ground protection and careful rigging keep yards in Mount Pleasant clean and usable once the work is complete.</p>
          <p>We also advise on post-removal options like replanting, adding a new shade tree, or opening up space for gardens and patios. Our team can point you toward species that thrive in Mount Pleasant and won’t outgrow the space too quickly.</p>
          <h3>Local Considerations in Mount Pleasant</h3>
          <p>Because removals can impact neighboring properties, we coordinate access points and communicate clearly about timing. That extra planning keeps the work smooth in Mount Pleasant blocks where space is shared.</p>
          ...
          <p>Local soil conditions and drainage patterns matter when removing large trees. In parts of Mount Pleasant where the ground is softer, we take extra care around root plates and nearby landscaping to prevent shifting or rutting.</p>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-charcoal mb-4">Need Tree Removal in Mount Pleasant?</h2>

...
const faqs = [
  ...
  },
  {
    ...
    "answer": "Yes. Many homeowners in Greenfield request log lengths for milling or firewood. Let us know your goals during the estimate and we’ll stage and cut accordingly."
  },
  {
    "question": "Do I need a permit for removing a tree in Greenfield?",
  ...
  {
    "question": "How do you remove large trees in Greenfield without damaging nearby homes?",
    "answer": "We use sectional removal with rigging so limbs and trunk pieces are lowered in controlled steps. That’s especially important on tight lots in areas like Olde Greenfield, Root River Corridor, Konkel Park area where fences, garages, and nearby power lines leave little room for a full drop."
  }
]

export default function GreenfieldTreeRemovalPage() {
  const crumbs = [
  {
    "name": "Home",
  ...
  {
    "name": "Greenfield",
    "item": "https://urbanloggers.org/greenfield/"
  },
  {
    "name": "Tree Removal",
    "item": "https://urbanloggers.org/greenfield/tree-removal/"
  }
]
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            serviceSchema(
              'Tree Removal',
              'Safe tree removal with rigging, cleanup, and optional log milling. in Greenfield, WI.',
              'https://urbanloggers.org/greenfield/tree-removal/',
      ...
      <section className="relative text-white py-14 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Tree Removal in Greenfield, WI</h1>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto prose-brand">
          <h2>Greenfield Tree Removal Focused on Safety and Results</h2>
          <p>Tree removal is rarely a simple cut-and-drop job in Greenfield. Many properties have tight access, overhead utilities, and mature canopies that grew long before today’s home additions. We evaluate the tree’s lean, canopy weight, and root stability before making the first cut. That detailed planning keeps the job safe for your home and for neighbors in nearby blocks like Olde Greenfield, Root River Corridor, Konkel Park area.</p>
          <p>Urban Loggers LLC is led by Brian Smith and backed by 20+ years of hands-on tree work. We’re fully insured and we show up with the right equipment—rigging systems, safety lines, and when necessary, cranes for large canopies. Our local experience means we know how to manage street parking, coordinate with neighbors, and keep the job tidy in busy parts of Greenfield.</p>
          <h3>Why Greenfield Homeowners Choose Urban Loggers</h3>
          ...
          <p>We also advise on post-removal options like replanting, adding a new shade tree, or opening up space for gardens and patios. Our team can point you toward species that thrive in Greenfield and won’t outgrow the space too quickly.</p>
          <p>If access is limited, we can stage equipment to minimize impact on lawns and landscaping. Ground protection and careful rigging keep yards in Greenfield clean and usable once the work is complete.</p>
          <h3>Local Considerations in Greenfield</h3>
          <p>Because removals can impact neighboring properties, we coordinate access points and communicate clearly about timing. That extra planning keeps the work smooth in Greenfield blocks where space is shared.</p>
          <p>Local soil conditions and drainage patterns matter when removing large trees. In parts of Greenfield where the ground is softer, we take extra care around root plates and nearby landscaping to prevent shifting or rutting.</p>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-charcoal mb-4">Need Tree Removal in Greenfield?</h2>
      ...
      {/* Internal links */}
      <nav aria-label="Related Greenfield services" className="py-8 px-4 bg-warm-white border-t border-gray-100">
        <div className="max-w-4xl mx-auto">
          <p className="text-sm text-gray-500 mb-3">Explore more Greenfield services:</p>
          <div className="flex flex-wrap gap-3">
            <Link href="/greenfield/" className="text-brand-green hover:underline text-sm">← Greenfield hub</Link>
            <Link href="/greenfield/tree-removal/" className="text-brand-green hover:underline text-sm">Tree Removal</Link>
            <Link href="/greenfield/tree-trimming/" className="text-brand-green hover:underline text-sm">Tree Trimming</Link>
            <Link href="/greenfield/stump-grinding/" className="text-brand-green hover:underline text-sm">Stump Grinding</Link>
            <Link href="/greenfield/emergency/" className="text-brand-green hover:underline text-sm">Emergency Tree Service</Link>
            <Link href="/greenfield/log-milling/" className="text-brand-green hover:underline text-sm">Log Milling</Link>
          </div>
        </div>
      </nav>
    </>
